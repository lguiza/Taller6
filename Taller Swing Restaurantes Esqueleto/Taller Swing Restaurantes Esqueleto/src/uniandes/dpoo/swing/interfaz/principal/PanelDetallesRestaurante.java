...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    public PanelDetallesRestaurante( )
    {
    	...
    	labCalificacion.setOpaque(true);
    	panelCalif.add(labCalificacion);

        // Configura el checkbox para indicar si ya se visitaó o no el restaurante
        // TODO completar el constructor
    	JPanel panelVis = new JPanel(new FlowLayout(FlowLayout.LEFT));
    	chkVisitado= new JCheckBox("Visitado");
    	panelVis.add(chkVisitado);

        // Organiza los elementos en la venta
        // TODO completar el constructor
    	JPanel estePrinc = new JPanel(new GridLayout(3,1));
    	estePrinc.add(panelNombre);
    	estePrinc.add(panelCalif);
    	estePrinc.add(panelVis);
    	add(estePrinc, BorderLayout.CENTER);
    }
